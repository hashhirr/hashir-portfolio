  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Hashir Qureshi",
          from_email: form.email,
          to_email: "hashirqureshi@example.com",
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className='desc-paragraph decorated text-[14px] leading-[24px]'>I usually reply within 24 hours. Feel free to share any details that help me understand your goals.</p>
